...
// Copied from: https://github.com/angular/angular/blob/16.2.10/packages/core/rxjs-interop/test/to_observable_spec.ts
/**
 * @license
...
describe('toObservable()', () => {
    ...
    it('should produce an observable that tracks a signal', async () => {
        ...
        const counterValues = toObservable(counter, { injector })
            .pipe(take(3), toArray())
            .toPromise();
